...
public class AssertionsTest {
    ...
    public void assertionOnStatus() {
        Assertions assertions = Utils.parseStringAs(ASSERTION_STATUS, Assertions.class);
        Assert.assertEquals((Integer) 201, assertions.getStatus());
    }

    @Test
    public void assertionOnHeaders() {
        Assertions assertions = Utils.parseStringAs(ASSERTION_HEADERS, Assertions.class);
