...
public class StepTest {
    ...
    public void stepCreation() {
        Utils.parseStringAs(STEP_1, Step.class);
        Utils.parseStringAs(STEP_2, Step.class);
        Utils.parseStringAs(STEP_3, Step.class);
    }

    @Test
    public void stepWithParamsCreation() throws UnsupportedEncodingException {
        Step parse = Utils.parseStringAs(STEP_4, Step.class);
    ...
    public void stepWithHeadersCreation() {
        Step parse = Utils.parseStringAs(STEP_5, Step.class);
